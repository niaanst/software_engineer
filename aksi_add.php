...
<body>
  ...
  <div class="container">   
  <h1>Selamat Anda sudah selesai mendaftar!!</h1> 
  <br/>
...
<?php
 ...
 $q = "INSERT INTO `db_loker`.`tabelform` 
 			(`nama`, `alamatktp`, `alamat`, `pendidikan`, `univ`, `ipk`, `ktp`, `posisi`)  
 		VALUES 
 			('$nama', '$alamatktp', '$alamat', '$pendidikan', '$univ', '$ipk', '$ktp', '$posisi')";
...
?>
<h2> Untuk melihat hasil kamu kamu bisa klik link berikut </h2>
</br>
